...
export const FORM_TEMPLATE_INFO: Record<
  FormTemplateType,
  {
    label: string;
    description: string;
...
> = {
  eu632: {
    ...
    description:
      "Filed with Cal/OSHA after ALL violations on a Preliminary Order are corrected. One form per conveyance.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/compliance%20form%20Doc%20EU-632.pdf",
    filedWith: "Cal/OSHA District Office that issued the Preliminary Order",
    filedWhen:
      "After all corrective work is complete — before the compliance deadline on the PO",
  },
  eu787: {
    label: "EU-787 — Annual & 5 Year Test Notification",
    description:
      "Filed with Cal/OSHA district office BEFORE scheduled annual or 5-year tests. Groups III and IV.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/Test%20Notification%20Form%20Doc%20EU-787%20fillable.pdf",
    filedWith: "Cal/OSHA District Office",
    filedWhen:
      "Before the test — confirm specific lead time with your district office",
  },
  eu776: {
    label: "EU-776 — Annual Testing Form",
    description: "Filed with Cal/OSHA after annual testing is complete.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/Annual%20Tesing%20Form%20Doc%20%20EU-776.pdf",
    filedWith: "Cal/OSHA District Office",
  ...
  dosh100: {
    ...
    description:
      "Requests a Division inspection for permit renewal or post-repair reinspection.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/reinspection-request-form-a.pdf",
    filedWith: "Cal/OSHA District Office",
    filedWhen:
      "When requesting reinspection after repairs, or for permit renewal",
  },
  eu215: {
    label: "EU-215 — Intent to Install",
    description: "Filed before new elevator installation begins.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/Intent%20To%20Install%20Form%20Doc%20EU-215.pdf",
    filedWith: "Cal/OSHA District Office",
  ...
  eu237: {
    ...
    description:
      "Filed before a material alteration begins. A §7301.1 permit must already be obtained.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/Intent%20to%20Alter%20EU-237%20fillable.pdf",
    filedWith: "Cal/OSHA District Office",
  ...
  eu943: {
    ...
    description:
      "Filed when building ownership or property management changes.",
    officialUrl:
      "https://www.dir.ca.gov/dosh/elevator/Change%20in%20responsible%20Party%20Form%20Doc%20EU-943%20fillable.pdf",
  ...
  return fields.map((field) => ({
    ...
    value: (() => {
      try {
        ...
        if (name === "PDFCheckBox")
          return (field as any).isChecked() ? "true" : "false";
        if (name === "PDFDropdown")
          return (field as any).getSelected()?.[0] ?? "";
        return "";
      } catch {
        return "";
      }
...
export function buildFieldMappings(
  ...
  set(city, "City", "city", "City Name", "cityName");

  set(zip, "Zip", "zip", "ZIP", "Zip Code", "zipCode", "Postal Code");

  set(
    String(parsedData.equipmentId ?? parsedData.serialNumber ?? ""),
    "State No",
    "StateNo",
    "state_no",
    "State ID",
  ...
  set(
    String(parsedData.inspectionDate ?? ""),
    "Inspection Date",
    "inspectionDate",
    "Date of Inspection",
    "Insp Date",
  ...
  if (jobData) {
    ...
    set(
      String(jobData.mechanicLicense ?? ""),
      "CCCM",
      "CCCM#",
      "cccm",
      "License No",
